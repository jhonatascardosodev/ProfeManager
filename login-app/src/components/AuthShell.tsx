      ...
      <aside className="login-aside" aria-label="Apresentação da marca">
        <div className="brand">
          ...
          <p className="brand-subtitle">
            Plataforma para organizar turmas, planejamento e acompanhamento pedagógico em um único lugar.
          </p>
          <ul className="brand-highlights" aria-label="Diferenciais do sistema">
            <li>Gestão de sala simplificada</li>
            <li>Planejamento por disciplina</li>
            <li>Experiência clara e segura</li>
          </ul>
        </div>
      </aside>
